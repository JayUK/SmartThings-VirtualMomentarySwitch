...
preferences {
	...
	section("On actions"){
		input "on_duration", "number", title: "Time (in seconds) switch should stay on for once turned on", range: "0..600", required: false
	}
 }

metadata {

    definition (name: "Virtual Switch with configurable momentary duration", namespace: "JayUK", author: "JayUK", runLocally: false, mnmn: "SmartThings", vid: "generic-switch") {
        capability "Switch"
